...
RecognizeStream.prototype.initialize = function() {
  ...
  var url = (options.url || 'wss://stream.watsonplatform.net/speech-to-text/api').replace(/^http/, 'ws') + '/v1/recognize?timestamps=true&smart_formatting=true&split_transcript_at_phrase_end=true' + '&model=' + queryParams.model + '&access_token=' + queryParams.access_token;
